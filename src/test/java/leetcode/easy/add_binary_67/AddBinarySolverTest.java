...
public class AddBinarySolverTest {
    private AddBinarySolver addBinarySolver;

    @BeforeEach
    public void setUp() {
        addBinarySolver = new AddBinarySolver();
    }
    ...
    public void can_add_two_binary_numbers() {
        ...
        Assertions.assertEquals("110111101100010011000101110110100000011101000101011001000011011000001100011110011010010011000000000", addBinarySolver.add(a, b));
    }
