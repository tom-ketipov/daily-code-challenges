...
class SolutionTest {
    ...
    public void numberOfPairs_throws_illegal_argument_exception_if_the_first_array_length_is_empty() {
        ...
        try {
            ...
            Assertions.assertEquals(ValidationMessageType.OUT_OF_RANGE_ARRAY_LENGTH_ERROR.getExceptionMessage(solution.getMinArrLength(), solution.getMaxArrLength()), e.getMessage());
        }
    }
