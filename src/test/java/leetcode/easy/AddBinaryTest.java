...
public class AddBinaryTest extends BaseTest {
    ...
    public void can_add_two_binary_numbers() {
        ...
        Assertions.assertEquals("10101", addBinarySolver.addBinary(binaryValueA, binaryValueB));
    }
    ...
    public void can_handle_long_type_numbers() {
        ...
        Assertions.assertEquals("10110000000000000000000010101100101", addBinarySolver.addBinary(binaryValueA, binaryValueB));
    }
    ...
    public void can_handle_bin_integer_type_numbers() {
        ...
        Assertions.assertEquals("110111101100010011000101110110100000011101000101011001000011011000001100011110011010010011000000000", addBinarySolver.addBinary(binaryValueA, binaryValueB));
    }
}
