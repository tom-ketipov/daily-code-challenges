...
public class AddBinaryTest extends BaseTest {
    ...
    public void can_add_two_binary_numbers() {
        ...
        assertEquals("10101", addBinarySolver.addBinary(binaryValueA, binaryValueB));
    }
    ...
    public void can_handle_long_type_numbers() {
        ...
        assertEquals("10110000000000000000000010101100101", addBinarySolver.addBinary(binaryValueA, binaryValueB));
    }
