...
class OperationPerformanceValueSolverTest {

    private OperationPerformanceValueSolver operationPerformanceValueSolver;

    @BeforeEach
    void setUp() {
        operationPerformanceValueSolver = new OperationPerformanceValueSolver();
    }
