...
class ConcatenationOfArraySolverTest {

    private ConcatenationOfArraySolver concatenationOfArraySolver;

    @BeforeEach
    void setUp() {
        concatenationOfArraySolver = new ConcatenationOfArraySolver();
    }
    ...
    public void getConcatenation_throws_illegal_argument_exception_for_empty_arrays() {
        try {
            ...
            Assertions.assertEquals(ValidationMessageType.OUT_OF_RANGE_ARRAY_LENGTH_ERROR.getExceptionMessage(1, 1000), e.getMessage());
        }
    }
}