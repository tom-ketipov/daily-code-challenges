...
class SolutionTest {
    private Solution permutationArrayBuilder;

    @BeforeEach
    void setUp() {
        permutationArrayBuilder = new Solution();
    }
    ...
    public void permutationArrayBuilder_throws_illegal_argument_exception_for_input_array_with_length_bigger_than_one_thousand() {
        ...
        try {
            ...
            Assertions.assertEquals(ValidationMessageType.OUT_OF_RANGE_LENGTH_ERROR.getExceptionMessage(0, permutationArrayBuilder.getMaxArrayLength()), e.getMessage());
        }
    }
