...
public class ArrayShuffleSolver {
    public int[] shuffle(int[] nums, int n) {
        Validate.notNull(nums, ValidationMessageType.NULL_VALUE_ERROR.getExceptionMessage());
        Validate.inclusiveBetween(1, Integer.MAX_VALUE, nums.length, ValidationMessageType.OUT_OF_RANGE_ARRAY_LENGTH_ERROR.getExceptionMessage(1, Integer.MAX_VALUE));
