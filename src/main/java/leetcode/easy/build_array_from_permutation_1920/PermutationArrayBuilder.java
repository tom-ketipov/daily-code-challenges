...
public class PermutationArrayBuilder {
    ...
    public int[] buildArray(int[] nums) {
        ...
        Validate.inclusiveBetween(0, getMaxArrayLength(), nums.length, ValidationMessageType.OUT_OF_RANGE_ARRAY_LENGTH_ERROR.getExceptionMessage(0, getMaxArrayLength()));
